 ...
 */
declare const awaiter: <T extends (...args: any[]) => any>(run: T) => (...args: Parameters<T>) => Promise<Awaited<ReturnType<T>>>;
...
declare const str: {
     ...
     */
    table(...arr: (number | string | string[] | null)[] | (number | string | string[] | null)[][]): string;
};
