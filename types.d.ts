...
declare class RateError extends Error {
    type: string;
}
declare const rate: <T extends (...args: any[]) => any, K = string>(run: T, { key, rateName, delay, }?: {
    key?: (args: Parameters<T>) => K;
    rateName?: string;
    delay?: number;
...
interface IScheduleParams<P extends any[]> {
    onSchedule: (args: P) => Promise<void>;
    delay?: number;
}
interface IWrappedScheduleFn<T extends any = any, P extends any[] = any> {
    (...args: P): Promise<T | null>;
    clear(): void;
}
declare const schedule: <T extends unknown = any, P extends any[] = any[]>(run: (...args: P) => Promise<T>, { onSchedule, delay }: IScheduleParams<P>) => IWrappedScheduleFn<T, P>;
...
declare const pubsub: {
    ...
    fromMap<Data = any>(map: IPubsubMap<Data>): {
        clear: () => Promise<void>;
        getFirst: () => Promise<[string, Data]>;
        length: () => Promise<number>;
        push: ([key, value]: [string, Data]) => Promise<void>;
        shift: () => Promise<[string, Data]>;
        [Symbol.asyncIterator](): AsyncIterableIterator<[string, Data]>;
    };
};
 ...
 */
declare const makeExtendable: <T extends Ctor<any>>(BaseClass: T) => T;
...
declare const split: (...arr: (string | string[] | null)[] | (string | string[] | null)[][]) => string[];
...
declare class FetchError extends Error {
    ...
    constructor(originalError: any, request: RequestInfo, response: Response | undefined, statusCode: number, info?: RequestInfo | URL | null, init?: RequestInit | null);
}
/**
...
declare class ToolRegistry<T extends Record<string, unknown> = {}> {
    ...
    override: <K extends string, U>(name: K, tool: U) => ToolRegistry<T & Record<K, U>>;
